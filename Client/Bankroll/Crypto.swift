...
//  Bankroll
//
//  Created by Mohan Lakshmanan on 6/26/15.
...
class Crypto {
    ...
    init(message: NSString, password: NSString) {
        ...
        self.eData = ACEncryptor.encryptData(self.data, password: self.password as! String, error: nil)
    ...
    func encryptPassword(publicKey : NSString) -> NSString {
        ...
        self.ePassword = RSA.encryptString(self.password as! String, publicKey: self.publicKey as! String)
        return self.ePassword
    }
